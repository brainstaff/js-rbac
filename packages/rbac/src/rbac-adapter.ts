...
export class RbacAdapter {
  ...
  async findItemChildrenByParent(
    name: RbacItem["name"],
  ): Promise<RbacItemChild[]> {
  ...
  async findAssignment(
    ...
    role: RbacItem["name"],
    contextId?: RbacContextId,
  ): Promise<RbacAssignment | null | undefined> {
